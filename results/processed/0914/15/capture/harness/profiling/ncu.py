...
def capture(args):
    ...
    report = args.output / args.report_name
    ...
    elif args.replay_mode == "application":
        cmd += ["--profile-from-start", "off", "--app-replay-mode", "strict",
                "--app-replay-match", "grid", "--app-replay-buffer", "file"]
    if args.nvtx_scope:
...
def main():
    ...
    c.add_argument("--report-name", default="action_expert")
    ...
    c.add_argument("--replay-mode", choices=("kernel", "range", "application"), default="kernel")
